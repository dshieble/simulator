...
if ~isempty(varargin)
    ...
    for i = 1:length(varargin)
        try 
            ...
            getConstantProperty(varargin{i}, 'OverlappingGenerations');
...
for i = 1:length(classNames)
    ...
    classConstants(i).OverlappingGenerations = getConstantProperty(classNames{i}, 'OverlappingGenerations');
...
if parameter_manager.mutating && parameter_manager.num_loci > 1
    ...
    if parameter_manager.classConstants(parameter_manager.current_model).OverlappingGenerations
...
if on
    ...
    handles.plot_button_age.Enable = 'on';
    ...
    handles.plot_button_age.Enable = 'off';
